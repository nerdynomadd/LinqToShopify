...
namespace LinqToShopify.GraphQL.Admin.Context.ProductCollection.Global.Types.Publishable
{
	public class Publishable : Node, IPublishable
	{
		...
		public bool PublishedOnPublication([GraphNonNullableParameter] [GraphParameterType(typeof(ID))] int publicationId) => _publishedOnPublication;

		private ResourcePublicationConnection _resourcePublications;
		...
		[GraphBackingField(nameof(_resourcePublications))]
		public ResourcePublicationConnection ResourcePublications(string? after = null, string? before = null, int? first = null, int? last = null, bool onlyPublished = true, bool reverse = false) => _resourcePublications;
		
		private ResourcePublicationV2Connection _resourcePublicationsV2;
		...
		[GraphBackingField(nameof(_resourcePublicationsV2))]
		public ResourcePublicationV2Connection ResourcePublicationsV2(string? after = null, string? before = null, int? first = null, int? last = null, bool onlyPublished = true, bool reverse = false) => _resourcePublicationsV2;
		
		private PublicationConnection _unpublishedPublications;
